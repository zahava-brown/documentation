...
[F5 NGINX Instance Manager]({{< ref "/nim/fundamentals/dashboard-overview/" >}}) provides a centralized interface where you can create, modify, and publish policies, attack signatures, and threat campaigns for NGINX App Protect WAF. You can use Instance Manager to deploy configuration updates to one, some, or all your NGINX App Protect WAF data plane instances simultaneously.
...
[NGINX Management Suite Security Monitoring]({{< ref "/nim/nginx-app-protect/security-monitoring/" >}}) provides a centralized visualization tool that lets you analyze threats, view protection insights, and identify areas for policy tuning.
