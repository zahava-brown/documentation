...
| Integrations                           | The integrations process includes features for interacting with external components, like configuring [F5 WAF for NGINX policies]({{< ref "/nim/nginx-app-protect/setup-waf-config-management.md" >}}), managing threat campaigns, and more. |
